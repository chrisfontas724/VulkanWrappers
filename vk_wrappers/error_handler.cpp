...
std::string ErrorHandler::description(const VkResult& result) {
    switch (result) {
        ...
        case VK_ERROR_FORMAT_NOT_SUPPORTED:       return "Vulkan format not suported";
        case VK_ERROR_FRAGMENTED_POOL:            return "Vulkan error fragmented pool";
        ...
        case VK_ERROR_SURFACE_LOST_KHR:           return "Vulkan surface lost KHR";
        case VK_ERROR_NATIVE_WINDOW_IN_USE_KHR:   return "Vulkan native window in use KHR";
        case VK_SUBOPTIMAL_KHR:                   return "Vulkan suboptimal KHR";
        case VK_ERROR_OUT_OF_DATE_KHR:            return "Vulkan out of date KHR";
        case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:   return "Vulkan incompatible display KHR";
        case VK_ERROR_VALIDATION_FAILED_EXT:      return "Vulkan validation failed EXT";
        case VK_ERROR_INVALID_SHADER_NV:          return "Vulkan Invalid Shader NV";
        case VK_ERROR_FRAGMENTATION_EXT:          return "Vulkan fragmentation EXT";
        case VK_ERROR_NOT_PERMITTED_EXT:          return "Vulkan not permitted EXT";
        case VK_ERROR_INVALID_DEVICE_ADDRESS_EXT: return "Vulkan invalid device address EXT";
        ...
        case VK_RESULT_MAX_ENUM:                  return "Vulkan max enum";
