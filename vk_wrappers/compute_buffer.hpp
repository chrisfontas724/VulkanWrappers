...
#ifndef DALI_GRAPHICS_VK_WRAPPERS_COMPUTE_BUFFER_HPP_
...
public:
    ...
    static std::shared_ptr<ComputeBuffer> createSourceBuffer(std::shared_ptr<LogicalDevice> device, vk::DeviceSize size) {
        auto flags = vk::BufferUsageFlagBits::eTransferSrc;
        auto type = vk::DescriptorType::eStorageBuffer;
        auto memory = vk::MemoryPropertyFlagBits::eHostCoherent | vk::MemoryPropertyFlagBits::eHostVisible;
        return std::shared_ptr<ComputeBuffer>(new ComputeBuffer(device, size, flags, type, memory));
    }

    static std::shared_ptr<ComputeBuffer> createHostAccessableBuffer(std::shared_ptr<LogicalDevice> device, vk::DeviceSize size) {
        auto flags = vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eTransferDst;
        auto type = vk::DescriptorType::eStorageBuffer;
        auto memory = vk::MemoryPropertyFlagBits::eHostCoherent | vk::MemoryPropertyFlagBits::eHostVisible;
        return std::shared_ptr<ComputeBuffer>(new ComputeBuffer(device, size, flags, type, memory));
    }

    static std::shared_ptr<ComputeBuffer> createHostAccessableUniform(std::shared_ptr<LogicalDevice> device, vk::DeviceSize size) {
        auto flags = vk::BufferUsageFlagBits::eUniformBuffer | vk::BufferUsageFlagBits::eTransferDst;
        auto type = vk::DescriptorType::eUniformBuffer;
        auto memory = vk::MemoryPropertyFlagBits::eHostCoherent | vk::MemoryPropertyFlagBits::eHostVisible;
        return std::shared_ptr<ComputeBuffer>(new ComputeBuffer(device, size, flags, type, memory));
    }

    static std::shared_ptr<ComputeBuffer> createStorageBuffer(std::shared_ptr<LogicalDevice> device, vk::DeviceSize size) {
    ...
    static std::shared_ptr<ComputeBuffer> createUniformBuffer(std::shared_ptr<LogicalDevice> device, vk::DeviceSize size) {
    ...
    static std::shared_ptr<ComputeBuffer> createFromVector(std::shared_ptr<LogicalDevice> device, 
        ...
        auto type = vk::DescriptorType::eStorageBuffer;
        auto memory = vk::MemoryPropertyFlagBits::eHostCoherent | vk::MemoryPropertyFlagBits::eHostVisible;
        auto staging_buffer = std::shared_ptr<ComputeBuffer>(new ComputeBuffer(device, buffer_size, flags, type, memory));
        ...
        auto dst_buffer = std::shared_ptr<ComputeBuffer>(new ComputeBuffer(device, buffer_size, dst_flags, dst_type, dst_memory));
    ...
    void access(vk::DeviceSize offset, std::function<void(T*)> func) {
        ...
        CXL_DCHECK(properties_ != vk::MemoryPropertyFlagBits::eDeviceLocal) << "Cannot access device-local memory on the host";
...
private:
    ...
    ComputeBuffer(std::shared_ptr<LogicalDevice> device,
                  vk::DeviceSize size,
...
#endif // DALI_GRAPHICS_VK_WRAPPERS_COMPUTE_BUFFER_HPP_