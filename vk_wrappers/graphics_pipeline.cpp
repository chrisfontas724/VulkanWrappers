...
GraphicsPipeline::GraphicsPipeline(
    std::shared_ptr<LogicalDevice> device, const cxl::FileSystem* fs,
...
GraphicsPipeline::GraphicsPipeline(
    std::shared_ptr<LogicalDevice> device, const std::vector<uint32_t>& vertex_shader,
    ...
    fragment_shader_ =
        std::make_unique<ShaderModule>(device, vk::ShaderStageFlagBits::eFragment, fragment_shader);
...
void GraphicsPipeline::initialize() {
    ...
    vk::PipelineShaderStageCreateInfo shader_stages[] = {vertex_shader_->create_info(),
